...
/// <summary>
/// 普通文本组件（TextDiv）构建器
/// 用于构建飞书卡片 2.0 格式的普通文本展示组件
/// </summary>
/// <remarks>
/// <para>TextDiv 是飞书卡片 2.0 中的普通文本展示组件（tag: "div"）。</para>
/// <para>主要用途：</para>
/// <list type="bullet">
...
/// <item>控制布局方向和间距</item>
/// </list>
/// <para>注意：TextDiv.Text 属性只能是 PlainText 类型（tag: "plain_text"），不能是 Markdown。</para>
/// </remarks>
/// <example>
/// 使用示例：
/// <code>
/// // 简单用法 - 纯文本
/// var element = new TextDivBuilder()
///     .Text("这是普通文本内容")
///     .Build();
/// 
/// // 设置样式
...
/// </code>
/// </example>
public class TextDivBuilder
{
    private readonly TextDiv _element = new();
    ...
    public TextDivBuilder Text(string content)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder Direction(string direction)
    {
    ...
    /// </summary>
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder Vertical()
    {
    ...
    /// </summary>
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder Horizontal()
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder Padding(string padding)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder VerticalSpacing(string spacing)
    {
    ...
    /// <param name="spacing">间距值，如 "small", "medium", "8px"</param>
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder HorizontalSpacing(string spacing)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder HorizontalAlign(AlignType align)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder VerticalAlign(AlignType align)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder Margin(string margin)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder ElementId(string id)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder Width(string width)
    {
    ...
    /// <returns>当前构建器实例（支持链式调用）</returns>
    public TextDivBuilder BackgroundStyle(string style)
    {
    ...
    /// 构建 TextDiv 对象
    /// </summary>
    /// <returns>完整的 <see cref="TextDiv"/> 对象</returns>
    public TextDiv Build() => _element;
}
